/*
 * PongoProbePrimitive.h
 */

#ifndef PRIMITIVES_PONGO_PROBE_PRIMITIVE_H_
#define PRIMITIVES_PONGO_PROBE_PRIMITIVE_H_
...
class PongoProbePrimitive : public Primitive {
public:
...
#endif /* PRIMITIVES_PONGO_PROBE_PRIMITIVE_H_ */
