 ...
 * SideloadPrimitive.h
 *
 * Normal-mode IPA install via installation_proxy (probe / execute gated).
 */

#ifndef PRIMITIVES_SIDELOAD_PRIMITIVE_H_
#define PRIMITIVES_SIDELOAD_PRIMITIVE_H_
...
class SideloadPrimitive : public Primitive {
public:
...
#endif /* PRIMITIVES_SIDELOAD_PRIMITIVE_H_ */
